...
# Open the data
data = np.load('/home/fmendez/Desktop/HD26965A_HARPS_data.npy').item()
...
for i in range(len(data['MJD'])):
    ...
    star_wavelength = data['wave'][i][276000:281000]
    star_flux = data['flux'][i][276000:281000]
...
plt.title(data['target'][i] + ' Ha Index Variability')
plt.xlabel('BJD')
plt.ylabel('Ha Index')
